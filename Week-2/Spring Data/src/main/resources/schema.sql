...
alter table country modify co_name varchar(100) not null;
...
create table if not exists employee_project (
    ep_em_id int not null,
    ep_pr_id int not null,
    primary key (ep_em_id, ep_pr_id),
    constraint fk_employee_project_employee foreign key (ep_em_id) references employee (em_id),
    constraint fk_employee_project_project foreign key (ep_pr_id) references project (pr_id)
);
...
insert into skill (sk_id, sk_name) values (202, 'Spring Data JPA');
insert into skill (sk_id, sk_name) values (203, 'MySQL');
insert into skill (sk_id, sk_name) values (204, 'Communication');

insert into project (pr_id, pr_name, pr_start_date) values (301, 'Banking Modernization', '2021-04-01');
insert into project (pr_id, pr_name, pr_start_date) values (302, 'Payroll Automation', '2022-02-15');
insert into project (pr_id, pr_name, pr_start_date) values (303, 'Reporting Dashboard', '2023-07-10');

insert into employee (em_id, em_name, em_email, em_salary, em_joining_date, em_dp_id)
values (101, 'Ananya Rao', 'ananya.rao@example.com', 92000, '2020-06-15', 1);
insert into employee (em_id, em_name, em_email, em_salary, em_joining_date, em_dp_id)
values (102, 'Arun Kumar', 'arun.kumar@example.com', 58000, '2021-03-20', 2);
insert into employee (em_id, em_name, em_email, em_salary, em_joining_date, em_dp_id)
values (103, 'Meera Nair', 'meera.nair@example.com', 76000, '2022-11-05', 1);
insert into employee (em_id, em_name, em_email, em_salary, em_joining_date, em_dp_id)
values (104, 'Daniel Joseph', 'daniel.joseph@example.com', 54000, '2019-09-12', 3);
insert into employee (em_id, em_name, em_email, em_salary, em_joining_date, em_dp_id)
values (105, 'Sanjay Patel', 'sanjay.patel@example.com', 83000, '2023-01-25', 1);
...
insert into employee_skill (es_em_id, es_sk_id) values (103, 201);
insert into employee_skill (es_em_id, es_sk_id) values (103, 203);
insert into employee_skill (es_em_id, es_sk_id) values (104, 203);
insert into employee_skill (es_em_id, es_sk_id) values (105, 202);
insert into employee_skill (es_em_id, es_sk_id) values (105, 203);

insert into employee_project (ep_em_id, ep_pr_id) values (101, 301);
insert into employee_project (ep_em_id, ep_pr_id) values (103, 301);
insert into employee_project (ep_em_id, ep_pr_id) values (102, 302);
insert into employee_project (ep_em_id, ep_pr_id) values (104, 303);
insert into employee_project (ep_em_id, ep_pr_id) values (105, 303);
